<%@ Page Title="" Language="VB" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="false"
    CodeFile="BranchLocatorMap.aspx.vb" Inherits="BranchLocatorMap" %>
                                    ...
                                    <div class="col-md-5">
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:DropDownList ID="ctyy" runat="server" AutoPostBack="false" AppendDataBoundItems="true"

<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="Branch-Locator-Details.aspx.cs" Inherits="Branch_Loactor_Detailss" %>
 ...
 <div class="table-container">
  <asp:Label ID="lblerr" runat="server"></asp:Label>
    <table id="Table2" style="width: 80%; border: solid thin #cccccc; border-color: #cccccc;"
            cellspacing="0" cellpadding="10" align="center" border="0" class="label2" runat="server" >
              ...
              <tr height="50px">
               <td align="left" valign="middle" colspan="6" bgcolor="#1E3A8E"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="681"><div align="center"><span style="color:White; font-size:large;font-family:Open Sans,Sans-Serif;">Address & Branch Info - </span><strong><asp:Label ID="Label2" runat="server" Font-Name="Open Sans,Sans-Serif;" Font-Size="14px" ForeColor="#FFFFFF"></asp:Label></strong> </div></td>
                  </tr>
                </table></td>
            </tr>
        ...
        <tr height="30px" runat="server" id="area">
            ...
            <tr height="30px" runat="server" id="micr">
             ...
             <tr height="30px" runat="server" id="rtgs">
                ...
                &nbsp;<a href="rtgs-neft-micr-branch-codes.aspx" target="_blank" style="font-family:Open Sans,Sans-Serif;">Click for RTGS / NEFT / MICR Codes</a> </td>
            </tr>
            ...
            <tr height="30px" style="background-color:#C90084; color:white;">
             ...
             <tr height="30px" runat="server" id="ATMFac" >
                ...
                &nbsp; <a href="atm-centres.aspx" target="_blank" style="font-family:Open Sans,Sans-Serif;">Click for ATM Details</a>  & <a href="eLobby-centres.aspx" target="_blank" style="font-family:Open Sans,Sans-Serif;">Click for eLobby Details</a> </td>
            </tr>
        ...
        <tr height="30px" id="ContactEid" runat="server" style="background-color:#C90084; color:white;">
         ...
         <tr height="30px" id="Tr5" runat="server">
               <td align="left" valign="middle" style=" width:40%;font-size:14px;font-family:Open Sans,Sans-Serif;">
                ...
                <td align="left" valign="middle" style=" width:40%;font-size:14px;font-family:Open Sans,Sans-Serif;">
                    <a href="Online-Feedback-Form.aspx" target="_blank"style="font-family:Open Sans,Sans-Serif;">Click Here to Write to the Branch Manager</a>
                </td>

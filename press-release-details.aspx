<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true"
    CodeFile="press-release-details.aspx.cs" Inherits="press_release_details" %>
  ...
  <div class="blog container" style="width: 92%;">
    <div class="row">
      <div class="col-md-9">
        ...
        <div class="tabbs">
        <div>
        Find the latest news worthy happenings at TMB. Get the latest upto date press release / announcements about new product launches, interest rates revisions, branch openings, atm openings, and other related information from us.<br /><br /></div>
        <div class="col-md-1">
...
<asp:Literal ID="TitleDescription" runat="server"></asp:Literal>
        <br /><br /></div><div class="main-contentz">
          <div class="table-container">
            ...
            <Columns>
                <asp:BoundColumn DataField="NoticeDate" HeaderText="Notice Date" Visible="False"></asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="FileHeading" HeaderText="Title"></asp:BoundColumn>

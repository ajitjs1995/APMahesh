...
</div><div class="fa_box two"> <img src="images/loan.png" alt=""><div> <a href="https://www.tmbnet.in/laps/ControllerServlet" target="_blank" style="color:#ffffff!important">Loans</a> </div></div>									
...
<div class="fl-sl"><div class="sl-im"><img src="images/Interest-strip-1.png" width="" height="" class="img-fluid" alt=""></div><div class="box"><div class="bx-head"><h1>MCLR / Deposit<br>Interest Rate </h1></div><div class="in-box iblne">
<div class="inb1"><span style="font-size:15px; color:#c6007c">1year MCLR</span><h1>8.65%</h1><span><a href="rates-at-a-glance.aspx"><img src="images/knowmore.png"  style="display:block!important; margin: auto;" align="center"></a></span></div><div class="inb1"><span style="font-size:15px; color:#c6007c">1year Deposit</span><h1>5.90%</h1>
<span><a href="deposit-interest-rates.aspx"><img src="images/knowmore.png"  style="display:block!important; margin: auto;" align="center"></a></span></div></div></div></div>
<!-- Start WOWSlider.com BODY section -->                         
	<div id="wowslider-container1"><div class="ws_images">
    <ul>        
     <li><img src="images/corona-fraud.jpg" alt="scams" title="" id="Img8"/></li>
	 <li><img src="images/scams.jpg" alt="scams" title="" id="Img2"/></li>
	 <li><img src="images/GECL-banner.jpg" alt="personal1" title="" id="Img1"/></li>
<%--	 <li><a href="https://www.tmb.in/covid-19-insurance-cover.aspx"><img src="images/rupaycovid.jpg" alt="personal1" title="" id="Img2"/></a></li>--%>
		...
		<li><img src="images/Aarogya-Setu-App-banner.png" alt="personal1" title="" id="Img5"/></li>
      <%--  <li><img src="images/personal1.jpg" alt="personal1" title="" id="wows1_0"/></li>--%>
       <%-- <li><img src="images/corona-onlinescam.png" alt="personal1" title="" id="Img6"/></li>	--%>	
		<!-- <li><img src="images/personal2.jpg" alt="personal2" title="" id="wows1_1"/></li>
		<li><img src="images/personal3.jpg" alt="personal3" title="" id="wows1_2"/></li>
		<li><img src="images/personal4.jpg" alt="personal4" title="" id="wows1_3"/></li> -->
		<!-- <li><img src="images/personal5.jpg" alt="personal5" title="" id="wows1_4"/></li>
		<li><img src="images/personal6.jpg" alt="personal6" title="" id="wows1_5"/></li> -->
		<!-- <li><img src="images/personal7.jpg" alt="personal1" title="" id="wows1_6"/></li>
		<li><img src="images/personal8.jpg" alt="personal2" title="" id="wows1_7"/></li> -->
<!-- 		<li><img src="images/personal9.jpg" alt="personal3" title="" id="wows1_8"/></li>        
 -->		<!-- <li><img src="images/personal10.jpg" alt="personal4" title="" id="wows1_9"/></li>	
		<li><img src="images/personal11.jpg" alt="personal1" title="" id="wows1_10"/></li> -->
		<!-- <li><img src="images/personal12.jpg" alt="personal2" title="" id="wows1_11"/></li>
		<li><img src="images/personal13.jpg" alt="personal3" title="" id="wows1_12"/></li>
		<li><img src="images/personal14.jpg" alt="personal4" title="" id="wows1_13"/></li>
		<li><img src="images/personal15.jpg" alt="personal5" title="" id="wows1_14"/></li> -->
...
<div class="item"><figure><img src="images/loan-icon.png" alt=""></figure><p>Loans</p><p class="MT10"><a href="https://www.tmbnet.in/laps/ControllerServlet" target="_blank" class="link">Apply Online</a></p></div>
...
<div class="col-md-5 col-sm-4 col-xs-12"><a href="https://www.tmbnet.in/onlinecarddesign/" target="_blank"> <img src="images/tmb-delightcard.png" class="img-responsive1"/></a></a></div>										
...
$(document).ready(function() {$('.popup-desktop').magnificPopup({items: [{
                                                src: '<div class="mpbox"><a id="fd"><img src="images/GECL-popup.jpg" width="616" height="600" /></a></div>',
                                                type: 'inline'
                                            }],}).trigger("click");                                    });

...
public partial class Admin_Manage_PgMenuMarathi : System.Web.UI.Page
{
    ...
    void Audit_Trail()
    {
        ...
        string PageNm = "Manage_PgMenuMarathi.aspx";
    ...
    public void fill_PageNames()
    {
        try
        {
            ...
            {
                cmd.Parameters["@Mode"].Value = "cntPgMarMaker";
            }
            ...
            if (cnt1 > 0)
            {
                ...
                {
                    cmd.Parameters["@Mode"].Value = "shPgMarMaker";
                }
            }
            da = new SqlDataAdapter();
            da.SelectCommand = cmd;
    ...
    public void bind_grid()
    {
        try
        {
            ...
            cmd.Parameters.AddWithValue("@strPageId", GetPgID);
                ...
                cmd.Parameters["@Mode"].Value = "CntMenuItemMarMkr";
         //   }
            cnt1 = (int)cmd.ExecuteScalar();
            con.Close();
            ...
            cmd.Parameters.AddWithValue("@strPageId", GetPgID);
                ...
                cmd.Parameters["@Mode"].Value = "CntMenuItemMarMkr1";
          //  }
            ...
            if (cnt3 > 0)
            {
                if (cnt1 > 0)
                {
                    ...
                    cmd.Parameters.AddWithValue("@strPageId", GetPgID);
                        ...
                        cmd.Parameters["@Mode"].Value = "ShMenuItemMarMkr";
                    //}
                    //else
                    //{
                ...
                if (cnt2 > 0)
                {
                    ...
                    //else
                    //{
                        cmd.Parameters["@Mode"].Value = "ShMenuItemMarMkr1";
                  //  }
                    da = new SqlDataAdapter();
                    da.SelectCommand = cmd;
    ...
    public void bind_gridleftmenu()
    {
        try
        {
            ...
            cmd.Parameters["@Mode"].Value = "CntMenuItemMLeft";
            //   }
            cnt1 = (int)cmd.ExecuteScalar();
            con.Close();
            ...
            cmd.Parameters["@Mode"].Value = "CntMenuItemMRLeft";
            //  }
            cnt2 = (int)cmd.ExecuteScalar();
            con.Close();
            int cnt3 = cnt1 + cnt2;
            ...
            if (cnt3 > 0)
            {
                if (cnt1 > 0)
                {
                    ...
                    cmd.Parameters["@Mode"].Value = "ShMenuItemMarMkrLeft";
    ...
    public void fill_MenuDtls(string lnkFileNm, string LnkId)
    {
        try
        {
            ...
            {
                cmd.Parameters["@Mode"].Value = "ShLnkByIdMarathi";
            }
            else if (filenm.Contains(".aspx"))
            {
                cmd.Parameters["@Mode"].Value = "ShLnkByIdMrt1";
            }
    ...
    public void bindchild(int pgid)
    {
        try
        {
            ...
            {
                cmd.Parameters["@Mode"].Value = "GetChildLnkMar";
            }
    ...
    public bool chk_data()
    {
        ...
        //else if (!string.IsNullOrEmpty(txtManuName.Text) & !Regex.IsMatch(txtManuName.Text, "^[a-zA-Z0-9-_%@,():./'& ]+$"))
        //{
    ...
    public void recurchild(int id1)
    {
        ...
        cmd.Parameters["@Mode"].Value = "GetMLnkMkrDel2";
        da = new SqlDataAdapter();
        da.SelectCommand = cmd;
        ...
        if (!(ds.Tables["tbl_LnkDtls2"].Rows.Count == 0))
        {
            ...
            for (i = 0; i <= ds.Tables["tbl_LnkDtls2"].Rows.Count - 1; i++)
            {
                ...
                {
                    cmd.Parameters["@Mode"].Value = "DelMarLnMkr1";
                }
                cmd.ExecuteNonQuery();
                con.Close();
            }
    ...
    protected void dg_Menu_ItemCommand1(object source, DataGridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "MenuCheck")
        {
            try
            {
                ...
                cmd.Parameters["@Mode"].Value = "updatemenustatusMrt";
                cmd.ExecuteScalar();
                ...
                cmd.Parameters.Add(new SqlParameter("@Mode", SqlDbType.VarChar, 50));
                cmd.Parameters.AddWithValue("@strLnkId", linkid1);
                cmd.Parameters["@Mode"].Value = "getmenuMrt";
                ...
                if (ds.Tables["tbl_cont"].Rows.Count > 0)
                {
                    ...
                    cmd.Parameters.Add(new SqlParameter("@Mode", System.Data.SqlDbType.VarChar, 20));
                    cmd.Parameters.AddWithValue("@strLnkId", linkid1);
                    cmd.Parameters["@Mode"].Value = "deletemenuMrt";
                    cmd.ExecuteNonQuery();
                    ...
                    cmd.Parameters["@Mode"].Value = "AddLnkMarthi";
                    cmd.ExecuteNonQuery();
                    ...
                    cmd.Parameters.Add(new SqlParameter("@Mode", System.Data.SqlDbType.VarChar, 20));
                    cmd.Parameters.AddWithValue("@strLnkId", linkid1);
                    cmd.Parameters["@Mode"].Value = "updatemenuchkMrt";
                    cmd.ExecuteNonQuery();
        ...
        else if (e.CommandName == "MenuDelete")
        {
            ...
            cmd.Parameters.AddWithValue("@strLnkId", linkid1);
                ...
                cmd.Parameters["@Mode"].Value = "GetMarLnkMkrDel";
            ...
            cmd.Parameters.Add(new SqlParameter("@Mode", System.Data.SqlDbType.VarChar, 20));
            cmd.Parameters.AddWithValue("@strLnkId", linkid1);
            cmd.Parameters["@Mode"].Value = "deletemenuMrtchk";
            cmd.ExecuteNonQuery();
            con.Close();
             bind_grid();
        }
                ...
                if (j == dg_Menu.Items.Count)
                {
                    ...
                    if (flag2 == dg_Menu.Items.Count)
                    {
                        ...
                        for (p = 0; p <= dg_Menu.Items.Count - 1; p++)
                        {
                            ...
                            {
                                cmd.Parameters["@Mode"].Value = "EditIndexMar";
                            }
                            cmd.ExecuteNonQuery();
                            con.Close();
                        }
            ...
            else if (chk_data() == true)
            {
                ...
                if (flag1 > 0)
                {
                    ...
                    if (btnAdd.Text == "Add")
                    {
                        ...
                        cmd.Parameters["@Mode"].Value = "ChkDupLnkMarathi";
                        cnt1 = (int)cmd.ExecuteScalar();
                        con.Close();
                        if (cnt1 == 0)
                        {
                            ...
                            if (RadioButtonList1.SelectedValue == "Left")
                            {
                                cmd.Parameters["@Mode"].Value = "GetMaxIndexMarL";
                            }
                            else
                            {
                                cmd.Parameters["@Mode"].Value = "GetMaxIndexMar";
                            }
                    ...
                    else if (btnAdd.Text == "Update")
                    {
                        ...
                        if (cnt2 == 0)
                        {
                            ...
                            if (!(cmbWebPage.SelectedIndex == 0))
                            {
                                ...
                                //else if (PgLang == "Marathi")
                                //{
                                    cmd.Parameters["@Mode"].Value = "CntPgMkrByIdMarathi";
                                //}
                                //else
                                //{
                                //    cmd.Parameters["@Mode"].Value = "CntPgMkrByIdMarathi";
                            ...
                            cmd.Parameters.Add(new SqlParameter("@Mode", System.Data.SqlDbType.VarChar, 50));
                            cmd.Parameters.AddWithValue("@strLnkId", LnkID);
                            cmd.Parameters["@Mode"].Value = "deletemenuMrtChek";
                            cmd.ExecuteNonQuery();
                            con.Close();
            ...
            if (!(dgchild.Items.Count == 0))
            {
                ...
                if (j == dgchild.Items.Count)
                {
                    ...
                    if (flag2 == dgchild.Items.Count)
                    {
                        ...
                        cmd.Parameters["@Mode"].Value = "getparentidMrt";
    ...
    protected void dgchild_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item | e.Item.ItemType == ListItemType.SelectedItem | e.Item.ItemType == ListItemType.AlternatingItem | e.Item.ItemType == ListItemType.EditItem)
        {
            ...
            if (Session["usr_privilege"].ToString() == "Checker1")
            {

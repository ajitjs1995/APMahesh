<%@ Page Title="" Language="C#" MasterPageFile="~/tmbadm/AdmMaster.master" AutoEventWireup="true" CodeFile="Manage_PgMenuMarathi.aspx.cs" Inherits="Admin_Manage_PgMenuMarathi" ValidateRequest="false"%>
  ...
  <tbody>
    <tr>
	  ...
	  <asp:Button ID="btnEditIndex" runat="server" Text="Update Right Menu Index" CssClass="btn1"
                        ...
                        <asp:Button ID="btneditleft" runat="server" 
              Text="Update Left Menu Index" CssClass="btn1"
                        Width="169px" onclick="btneditleft_Click"  />
                        &nbsp;&nbsp;

...
public partial class Admin_Manage_banner_Binary : System.Web.UI.Page
{
    SqlDataReader dr;
    ...
    private void bind_grid()
    {
        try
        {
            ...
            con.Open();
            cmd = new SqlCommand("Proc_ManageBanner_Binary", con);
    ...
    private bool chk_data()
    {
        ...
        {
            lblAddMsg.Text = "Width must not exceed 1350px or not less than 1366px !!";
            FUBanner.Focus();
            return false;
        }
        ...
        {
            lblAddMsg.Text = "Height must not exceed 280px or not less than 285px !!";
            FUBanner.Focus();
            return false;
        }

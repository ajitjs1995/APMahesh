...
public partial class Admin_Manage_PgMenuEnglish : System.Web.UI.Page
{
    ...
    public void getPagedetails(string LnkId)
    {
        try
        {
            ...
            cmd.Parameters["@Mode"].Value = "GetPageDetails";
    ...
    void Audit_Trail()
    {
        if (Session["PageName"] != "" && Session["PageName"] != null)
        {
            fields1 = "Page Name : " + Session["PageName"].ToString();
        }
        if (Session["MainParent"] != "" && Session["MainParent"] != null)
        {
            if (fields1 == "")
            {
        ...
        if (Session["PageType"] != "" && Session["PageType"] != null)
        {
            if (fields1 == "")
            {
        ...
        string PageNm = "Manage_PgMenuEnglish.aspx";
    ...
    public void bind_grid()
    {
        try
        {
            ...
            cmd.Parameters["@Mode"].Value = "CntMenuItemMkr2";
            ...
            if (cnt3 > 0)
            {
                if (cnt1 > 0)
                {
                    ...
                    cmd.Parameters["@Mode"].Value = "ShMenuItemMkr1";
                ...
                if (cnt2 > 0)
                {
                    ...
                    cmd.Parameters["@Mode"].Value = "ShMenuItemMkr2";
    ...
    public void bind_gridleft()
    {
        try
        {
            ...
            cmd.Parameters["@Mode"].Value = "CntMenuItemLeft";
            ...
            if (cnt3 > 0)
            {
                if (cnt1 > 0)
                {
                    ...
                    cmd.Parameters["@Mode"].Value = "ShMenuItemLeft";
                    SqlDataAdapter da1 = new SqlDataAdapter();
                    da1.SelectCommand = cmd;
                    ds = new DataSet();
                    da1.Fill(ds, "tbl_MenuDtls1");
                    //  con.Close();
                }
                if (cnt2 > 0)
                {
                ...
                if (flag1 == 1)
                {
                    ...
                    if (!(ds.Tables["tbl_MenuDtls1"].Rows.Count == 0))
                    {
                        ...
                        if (Session["utype"].ToString() == "Maker" || Session["utype"].ToString() == "admin" || Session["utype"].ToString() == "Both")
                        {
                            btneditlftmenu.Visible = true;
                        }
                        else
                        {
                            btneditlftmenu.Visible = true;
                            btneditlftmenu.Enabled = false;
                        }
                        try
                        {
    ...
    public void fill_MenuDtls(string lnkFileNm, string LnkId)
    {
        try
        {
            ...
            {
                cmd.Parameters["@Mode"].Value = "ShLnkByIdM";
            }
            else if (filenm.Contains(".aspx"))
            {
                cmd.Parameters["@Mode"].Value = "ShLnkByIdM1";
            }
    ...
    public void bindchild(int pgid)
   {
        try
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@Mode", System.Data.SqlDbType.VarChar, 20));
                ...
                cmd.Parameters["@Mode"].Value = "GetChildLnkM1";
    ...
    public bool chk_data()
    {
        ...
        else if (string.IsNullOrEmpty(txtManuName.Text))
        {
            lblMainMsg.Text = "Please enter menu text !!";
            txtManuName.Focus();
            return false;
        }
        else if (txtManuName.Text.Length < 2)
        {
            lblMainMsg.Text = "Enter minimum 2 characters in Menu Text";
            txtManuName.Focus();
            return false;
        }
        else if (txtManuName.Text.Length > 300)
        {
    ...
    public void recurchild(int id1)
    {
        ...
        cmd.Parameters["@Mode"].Value = "GetLnkMkrDel2";
        da = new SqlDataAdapter();
        da.SelectCommand = cmd;
    ...
    protected void dg_Menu_ItemCommand1(object source, DataGridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "AddChild")
        {
            ...
            //dg_Menu.Columns[3].Visible=false;
        }
        ...
        else if (e.CommandName == "MenuCheck")
        {
            try
            {
                ...
                cmd.Parameters["@Mode"].Value = "updatemenustatusEng";
                cmd.ExecuteScalar();
                ...
                cmd.Parameters.Add(new SqlParameter("@Mode", SqlDbType.VarChar, 50));
                cmd.Parameters.AddWithValue("@strLnkId", linkid1);
                cmd.Parameters["@Mode"].Value = "getmenuEng";
                ...
                if (ds.Tables["tbl_cont"].Rows.Count > 0)
                {
                    ...
                    cmd.Parameters.Add(new SqlParameter("@Mode", System.Data.SqlDbType.VarChar, 20));
                    cmd.Parameters.AddWithValue("@strLnkId", linkid1);
                    cmd.Parameters["@Mode"].Value = "deletemenuEnglish";
                    cmd.ExecuteNonQuery();
        ...
        else if (e.CommandName == "MenuDelete")
        {
            ...
            cmd.Parameters.AddWithValue("@strLnkId", linkid1);
                ...
                cmd.Parameters["@Mode"].Value = "GetLnkMkrDel";
            ...
            cmd.Parameters.Add(new SqlParameter("@Mode", System.Data.SqlDbType.VarChar, 20));
            cmd.Parameters.AddWithValue("@strLnkId", linkid1);
            cmd.Parameters["@Mode"].Value = "deletemenucheck";
            cmd.ExecuteNonQuery();
            con.Close();
            // bind_grid();
            bind_grid();
                ...
                if (j == dg_Menu.Items.Count)
                {
                    ...
                    if (flag2 == dg_Menu.Items.Count)
                    {
                        ...
                        for (p = 0; p <= dg_Menu.Items.Count - 1; p++)
                        {
                            ...
                            {
                                cmd.Parameters["@Mode"].Value = "EditIndexM1";
                            }
                            cmd.ExecuteNonQuery();
                            con.Close();
                        }
            ...
            else if (chk_data() == true)
            {
                ...
                if (flag1 > 0)
                {
                    ...
                    if (btnAdd.Text == "Add")
                    {
                        ...
                        cmd.Parameters["@Mode"].Value = "ChkDupLnkM1";
                        cnt1 = (int)cmd.ExecuteScalar();
                        con.Close();
                        if (cnt1 == 0)
                        {
                            ...
                            if (RadioButtonList1.SelectedValue == "Left")
                            {
                                ...
                                cmd.Parameters.AddWithValue("@strPageId", GetPgID);
                                cmd.Parameters.AddWithValue("@strParentLnkId", LnkParid);
                                cmd.Parameters.AddWithValue("@strmenulocation", "Left");
                                cmd.Parameters["@Mode"].Value = "GetMaxIndex1L";
                            }
                            else
                            {
                                cmd = new SqlCommand("Proc_User_Master", con);
                                ...
                                cmd.Parameters.AddWithValue("@strPageId", GetPgID);
                                cmd.Parameters.AddWithValue("@strParentLnkId", LnkParid);
                                cmd.Parameters.AddWithValue("@strmenulocation", "Right");
        ...
        else if (e.CommandName == "MenuCheckleft")
        {
            try
            {
                ...
                if (ds.Tables["tbl_cont"].Rows.Count > 0)
                {
                    ...
                    cmd = new SqlCommand("Proc_LVAmdMods", con);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@Mode", System.Data.SqlDbType.VarChar, 20));
                    cmd.Parameters.AddWithValue("@strLnkId", linkid1);
                    cmd.Parameters["@Mode"].Value = "deletemenuEnglish";
    ...
    protected void btneditlftmenu_Click(object sender, EventArgs e)
    {
        try
        {
            int i = 0;
            ...
            if (!(dgchild.Items.Count == 0))
            {
                ...
                if (j == dgchild.Items.Count)
                {
                    ...
                    if (flag2 == dgchild.Items.Count)
                    {
                        ...
                        cmd.Parameters["@Mode"].Value = "getparentid";

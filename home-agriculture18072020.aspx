<%@ Register Src="~/TopcntrlAgri.ascx" TagPrefix="uc" TagName="Topcntrl" %>
...
<script>
                        ...
                        <div class="herosliderRandomLogic section">
                          ...
                          <div class="fl-sl">
                            ...
                            <div id="wowslider-container1">
                                <div class="ws_images">
                                    <ul>
                                        <li><img src="images/agri1.jpg" alt="8" title="" id="wows1_3" class="img-responsive" /></li>
                                        <li><img src="images/agri2.jpg" alt="1" title="" id="wows1_0" class="img-responsive" /></li>
                                        <li><img src="images/agri3.jpg" alt="2" title="" id="wows1_1" class="img-responsive" /></li>
                                        <li><img src="images/agri4.jpg" alt="3" title="" id="wows1_2" class="img-responsive" /></li>
                                        <li><img src="images/agri5.jpg" alt="4" title="" id="wows1_3" class="img-responsive" /></li>
                                            ...
                                            <div>
                                                <div class="gray-box">
                                                    ...
                                                    <div class="gray-carosel owl-carousel">
                                                     ...
                                                     <div class="item">
                                                            <figure><img src="images/jewelloan-icon.png" alt=""></figure>
                                                            <p>Jewel Loan </p>
                                                           
                                                            <p class="MT10"><a href="jewel-loan.aspx" class="link">Know More  </a></p>
                                                        </div>
													...
													<p class="MT10"><a href="https://pgi.billdesk.com/pgidsk/pgmerc/instpy/TMBBBPSIndex.jsp" target="_blank" class="link">Pay Now </a></p>
                                                        ...
                                                        <div class="item">
                                                            <figure><img src="images/tractorloan-icon.png" alt=""></figure>
                                                            <p>Tractor Loan </p>
                                                           
                                                            <p class="MT10"><a href="tractor.aspx" class="link">Know More </a></p>
                                                        </div>
  ...
  <div class="item">
                                                            ...
                                                            <p class="MT10"><a href="https://www.billdesk.com/pgmerc/tmbtax/" target="_blank" class="link">Know More</a></p>
                                                        </div>
...
<li><a href="https://www.tmb.in/doc/P2020062501.pdf" target="_blank" style="color:#ffffff">Financial results for the year ended 31.03.2020<img src="../images/new.gif"></a></li><br>
 ...
 <li><a href="Branch-Locator-Details.aspx?ifsc=TMBL%200000221" style="color:#ffffff">Shifting of Palamedu Branch in Madurai Dist., TN</a></li>

 <li><a href="Branch-Locator-Details.aspx?ifsc=TMBL%200000037" style="color:#ffffff">Shifting of Kumbakonam Branch in Thanjavur Dist., TN</a></li>

 <li><a href="Branch-Locator-Details.aspx?ifsc=TMBL%200000144" style="color:#ffffff">Shifting of Marthandam in Kanyakumari Dist., TN</a></li>

 <li><a href="Branch-Locator-Details.aspx?ifsc=TMBL%200000278" style="color:#ffffff">Shifting of Asesham Branch in Thiruvarur Dist., TN</a></li> -->
                                            ...
                                            <div class="brow">
                                                <div class="col-lg-4 col-sm-4">
                                                    <div class="single-blog">
                                                            ...
                                                            <div class="blog-content">
                                                                <div class="blog-img">
                                                                <img class="full-width zoom" alt="" src="images/Jewel-Loan1.jpg"></div>
                                                                <div class="blog-text">
                                                                    <h4 class="char-65"><a href="jewel-loan.aspx" class="producttext" style="color:#c60180; text-decoration: none;">Jewel Loan</a></h4>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-lg-4 col-sm-4">
                                                    <div class="single-blog">
                                                            ...
                                                            <div class="blog-content">
                                                                <div class="blog-img">
                                                                    <img class="full-width zoom" alt="" src="images/Rice-Mill.jpg"></div>
                                                                <div class="blog-text">
                                                                    <h4 class="char-65"><a href="rice-mill.aspx" style="color:#c60180; text-decoration: none;">TMB Rice Mill</a></h4>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="single-blog">
                                                            ...
                                                            <div class="blog-content"> 
                                                                <div class="blog-img zoom">
                                                                    <img class="full-width" alt="" src="images/poultry.jpg"></div>
                                                                <div class="blog-text">
                                                      <h4 class="char-65"><a href="tmb-poultry-farm-broiler.aspx" style="color:#c60180; text-decoration: none;">TMB Poultry Farm - Broiler</a></h4>
                                                                </div>
                                                            </div>

    ...
    <div class="">
      ...
      <li style="float:left"><span class="wsmenu-click"><i class="wsmenu-arrow fa fa-angle-down"></i></span> <a href="" title="Contact Us"><strong class="mob-icon fa fa-male"></strong>Contact Us</a>
            <div class="megamenu clearfix" style="width: 266px;">
              <div class="dd-inner">
                <div class="column2 singledropdown"> <img src="images/ContactUs-top.jpg" alt="About Us" longdesc="" class="menucolimg">
                  <div class="" id="tab1"> 
...
<a href="searchpage.aspx?zoom_query="><img src="images/search1.png" style="float: right; margin-top: 13px;"></a>
  ...
  <ul>
    ...
    <li class="mega" data-column="5"><a href="contact-us.aspx" style="background: #c6017e;">Contact Us</a>
      <ul>
	   <li><a href="contact-us.aspx" title="Contact Us">Contact Us</a></li>
         <li><a href="online-feedback-form.aspx" title="Write to Us / Feedback">Write to Us / Feedback</a></li>
				  ...
				  <li><a href="whats-new.aspx" title="Whats New @ TMB">Whats New @ TMB</a></li>
				  <li><a href="customer-care-support.aspx" title="Customer Care / Support">Customer Care / Support</a></li>
				  <li><a href="customer-testimonials.aspx" title="Customer Care / Support">Customer Testimonials</a></li>

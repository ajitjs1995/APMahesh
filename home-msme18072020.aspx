<%@ Register Src="~/TopcntrlMSME.ascx" TagPrefix="uc" TagName="Topcntrl" %>
                    ...
                    <div>
                        ...
                        <div class="herosliderRandomLogic section">
                            ...
                            <div id="wowslider-container1">
                                <div class="ws_images">
                                    <ul>
                                        <li><img src="images/msme1.jpg" alt="8" title="" id="wows1_3" class="img-responsive" /></li>
                                        <li><img src="images/msme2.jpg" alt="1" title="" id="wows1_0" class="img-responsive" /></li>
                                        <li><img src="images/msme3.jpg" alt="2" title="" id="wows1_1" class="img-responsive" /></li>
                                        <li><img src="images/msme4.jpg" alt="3" title="" id="wows1_2" class="img-responsive" /></li>
                                                ...
                                                <div class="col-lg-4 col-sm-4">
                                                    <div class="single-blog">
                                                            ...
                                                            <div class="blog-content">
                                                                <div class="blog-img">
                                                                <img class="full-width zoom" alt="" src="images/TMB-Flexi-Current.jpg"></div>
                                                                <div class="blog-text">
                                                                    <h4 class="char-65"><a href="flexi-scheme.aspx" class="producttext" style="color:#c60180; text-decoration: none;">TMB Flexi Current Account</a></h4>
                                                                </div>
                                                            </div>

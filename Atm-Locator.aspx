<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="Atm-Locator.aspx.cs" Inherits="Atm_Locator" %>
...
<h4 class="panel-title"><a aria-controls="collapse3" aria-expanded="false" class="collapsed" data-parent="#accordion" data-toggle="collapse" href="#collapse3" role="button">List of Our Own 1151 ATM Centres</a></h4>
</div>
...
<div class="listing">
<ul>
	<li><a href="">Click Here to see List of our own ATM Network (same page, scroll down)</a></li>
</ul>
</div>
</div>
</div>
                        ...
                        <div class="main-white-box box-1 clearfix" style="background: #ececed; height: auto; border: none;">
                            ...
                            <div class="details-box">
                                <div class="hp-card-box">
                                    ...
                                    <div class="item-points em-desc share-comp-desc">
                                        <p>35% discount on Locker Rentals for the first year for every Savings Account</p>
                                    </div>
                                </div>
                                ...
                                <div class="clearfix">
                                    ...
                                    <a class="btn btn-primary em-cta related-product-click-apply" href="https://apply.">Apply Now</a>
                                </div>
                            </div>
                        </div>
                    </div>

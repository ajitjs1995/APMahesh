<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true"
    CodeFile="press-release.aspx.cs" Inherits="press_release" %>
  ...
  <div class="blog container" style="width: 92%;">
    <div class="row">
      <div class="col-md-9">
        ...
        <div class="tabbs">
        Welcome to Press Release at Tamilnad Mercantile Bank.<br />
        <br />
        ...
        <br />
        Please see Sale Notice for all updates about Sale Notices.<br /><br />
        <div class="main-contentz">
          <div class="table-container">
            ...
            <Columns>
                <asp:BoundColumn DataField="" HeaderText="ate" Visible="False"></asp:BoundColumn>
                <asp:TemplateColumn HeaderText="Date" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" >
      ...
      <div class="col-md-3 related-productsem" data-type="product">
        <div class="hp-main-box">
          ...
          <img class="rel-img-right em-img lazyloaded" srcset="images/products1.jpg" style="width: 100%; height: auto;display: block; border-radius: 4px 4px 0 0;">
            <div class="details-box">
              ...
              <div class="clearfix">
                ...
                <a class="btn btn-primary em-cta related-product-click-apply" href="https://www.tmbnet.in/laps/?PAGE_TYPE=R" target="_blank">Apply Now</a> </div>
            </div>
          </div>
        </div>
      </div>

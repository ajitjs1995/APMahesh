...
<%@ Register Src="~/pgcontactus.ascx" TagPrefix="uc" TagName="pgcontactus" %>
...
<head runat="server">
    ...
    <title>Tamilad Mercantile Bank Ltd - Contact Us</title>
...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
    ...
    <div>
        <uc:pgcontactus runat="server" ID="ucpgcontactus" />
    </div>
    </form>
</body>
</html>
